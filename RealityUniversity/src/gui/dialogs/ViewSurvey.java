...
public class ViewSurvey extends JDialog implements GuiInterface {
	...
	public ViewSurvey(final Survey survey) {
		...
		/**
		 * Determines the value of the following class-wide fields:
		 * 
		 * surveySalary spouseIncome spousalIncomeInfoLabel annualTaxesInfoLabel
		 * monthlyTaxesInfoLabel surveyMonthlyTaxes surveyAnnualTaxes
		 * surveyChildSupport
		 * 
		 */
		...
		classInfoPanel.setBorder(BorderFactory.createTitledBorder(blackBorder,
		...
		famiyInfoPanel.setBorder(BorderFactory.createTitledBorder(blackBorder,
		...
		occupationPanel.setBorder(BorderFactory.createTitledBorder(blackBorder,
		...
		// *******************************************
		occupationDescriptionLabel = new JLabel(
				"<html>In your student survey you selected "
						+ preferredJobInfo.getName()
		...
		occupationPanel.add(occupationDescriptionLabel,
				occupationDescriptionPanelConstraints);
		...
		occupationPanel
				.add(occupationInfoLabel, occupationInfoLabelConstraints);
		// Net Income - 3
		// *************************************************************
		...
		// *******************************************************************
		annualSalaryInfoLabel = new JLabel(FMT_CURRENCY.format(assignedJobInfo
				.getAnnGrossSal()));
		...
		occupationPanel.add(annualSalaryInfoLabel,
				annualSalaryInfoLabelConstraints);
		// Annual Taxes - 6
		// *************************************************************
		...
		occupationPanel.add(annualTaxesInfoLabel,
				annualTaxesInfoLabelConstraints);
		// Monthly Salary - 7
		// *******************************************************************
		...
		occupationPanel.add(monthlySalaryInfoLabel,
				monthlySalaryInfoLabelConstraints);
		// Monthly Taxes - 8
		// ****************************************************************
		...
		// *************************************************************************
		monthlyTaxesInfoLabel = new JLabel(
				FMT_CURRENCY.format(surveyMonthlyTaxes));
		...
		occupationPanel.add(monthlyTaxesInfoLabel,
				monthlyTaxesInfoLabelConstraints);
		// **********************************************************************
		...
		// ************************************************************************
		// Assemble sub panels inside mainPanel, mainPanel inside our JDialog
		// main
	...
	public JFrame paperFrameSetUp() {
		...
		classInfoPanel.setBackground(Color.white); // set this to help id gui
													// part
	 ...
	 * 
	 *            surveySalary spousalIncomeInfoLabel spouseIncome
	 *            annualTaxesInfoLabel monthlyTaxesInfoLabel surveyMonthlyTaxes
	 *            surveyAnnualTaxes surveyChildSupport
	 * 
	 */
	private void processFinancialInformation(Survey survey, Job assignedJobInfo) {
		...
		try {
			Job spouseJob = Controller.getControllerInstance().getJob("id",
					Integer.toString(spouseSurvey.getAssignedJob()));
			survey.getSpouse();
