...
public class ProcessChildrenDivorcedMales {
	...
	public List<Survey> doProcess() {
		...
		actualChildren = (double)lstDivWithChild.size()/lstDivorcedMales.size() ;
		actualNoChildren = (double)lstDivNoChild.size()/lstDivorcedMales.size() ;
	...
	public void adjustChildrenDown(){
		 ...
		 * a divorced man with kids and take his children away ...darn DFACS */
	...
	public void adjustChildrenUp(){
		...
		/*While our percentage of divorced with NO kids is to high we randomly select
		 * a divorced man with NO kids and give him children ...Surprise! */
