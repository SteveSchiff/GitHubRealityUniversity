...
public class ProcessChildrenDivorcedFemales {
	...
	public List<Survey> doProcess() {
		...
		for (Survey survey : lstSurveys) {
			...
			if (survey.getGender() == 1 && survey.getMarried() == 2){	
				...
				//If survey has children add to list divorced women with children
				...
				//If survey has NO children add to list divorced with no children
		...
		actualChildren = (double)lstDivWithChild.size()/lstDivorcedFemales.size() ;
		actualNoChildren = (double)lstDivNoChild.size()/lstDivorcedFemales.size() ;
	...
	public void adjustChildrenDown(){
		...
		/*While our percentage of divorced WITH kids is too high we randomly select
		 * a divorced woman with kids and take her children away  */
	...
	public void adjustChildrenUp(){
		...
		/*While our percentage of divorced with NO kids is too high we randomly select
		 * a divorced woman with NO kids and give her children  */
