...
public class ProcessChildren {
	...
	public void adjustChildrenUp(){
		...
		/*While our percentage of married with NO kids is to high we randomly select
		 * a married women with NO kids and give her children  */

		while ((double)marriedFemalesWithNoChildrenList.size()/marriedFemalesList.size() > marriedWithChildrenLimitRatio ){
