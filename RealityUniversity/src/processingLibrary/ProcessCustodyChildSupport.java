...
public class ProcessCustodyChildSupport {
	...
	public List<Survey> doProcess() {
		...
		//This can be uncommented. It will set childSupport to '0' for all surveys in group
		for (Survey empty : lstSurveys){
			if (empty.getChildSupport() != 0) empty.setChildSupport(0);
		}
		...
		System.out.println("Divorced females : " +lstDivFemalesWithChild.size() );
	...
	public void setChildSupportMale(){
		...
		//set 'i' to '1' for groups of 10 or more. If 'i' is not '0'no male in a group under 10 will receive child support
		int i = 0;
